...
@section('title', 'New Teaching Material | Dashboard | ' . config('app.name', 'Mikroliterasi'))
...
<div class="mx-auto w-full max-w-300 px-4 py-8 sm:px-6 sm:py-10 lg:px-8">
    ...
    <div class="mb-8">
        ...
        <div>
            ...
            <p class="mt-2 max-w-2xl text-sm leading-6 text-text-muted">
                Add a new teaching material and its presentation link.
            </p>
        </div>
    ...
    <div class="rounded-lg border border-border bg-surface p-6 sm:p-8">
        ...
        <form
            method="POST"
            action="{{ route('dashboard.teaching-materials.store') }}"
        >
